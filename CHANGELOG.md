...
Android: keep the active system-bar style across runtime theme changes.
...
[1.0.4]: https://github.com/promonteiro89/cordova-plugin-system-bars/releases/tag/1.0.4
