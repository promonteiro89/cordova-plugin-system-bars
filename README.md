...
{
  "plugin": {
    "url": "https://github.com/promonteiro89/cordova-plugin-system-bars.git#1.0.1"
  }
}
```

Pin the tag (`#1.0.1`) so MABS does not silently pull breaking changes.
...
```json
{
  ...
  "buildConfigurations": {
    "cordova": {
      "source": {
        "npm": "https://github.com/promonteiro89/cordova-plugin-system-bars.git#1.0.1"
      }
    }
  },
  "metadata": {
...
```sh
cordova plugin add https://github.com/promonteiro89/cordova-plugin-system-bars.git#1.0.1
```
